...
레벨업 시 장비가 드롭됩니다. 총 60종 장비 중 슬롯별로 하나씩 착용할 수 있으며, 각 펫의 인벤토리와 장착 상태는 독립적입니다. 아래는 대표 장비입니다.
...
배틀 능력치는 각 펫의 활동 통계, 희귀도와 해당 펫이 장착한 장비로 계산됩니다. 저장된 레벨은 그대로 유지하되 배틀 계산에만 레벨 50 상한을 적용합니다.
